 ...
 * 文案（title/destination/brief/variant label/detail/prediction/algo 名称）在 locale.ts，按 id 对应。
...
export const executeLevels: readonly ExecuteLevel[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      // 倍增预测门：先在最坏情形亲眼数出 15 = n(n−1)/2，通关时追问 n 翻倍后的增长级。
      { id: 'insertion-02-reversed', cells: [6, 5, 4, 3, 2, 1], par: { moves: 20, compares: 15 }, prediction: { answer: 0, when: 'done' } },
    ],
  },
  {
    kind: 'execute',
